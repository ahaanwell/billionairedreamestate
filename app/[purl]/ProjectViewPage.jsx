...
import { FaLayerGroup, FaArrowAltCircleDown } from "react-icons/fa";
import { FaLocationPin } from "react-icons/fa6";

function ProjectViewPage({ project }) {
  ...
  const handleFaq = (id) => setCurrId(currId === id ? null : id);
  const handleImageClick = (item) => setCurrViewImage(item);
